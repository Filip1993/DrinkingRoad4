...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupFragmentManager() {
         ...
         * Here , we are inflating the SwipeTabsFragment as the first Fragment
         */
        //uzmemo trenutni fragment...
        //unutar kontejnera, tj. FragmentLayout-a stavimo SwipeTabsFragment
        mFragmentManager = getSupportFragmentManager();
        mFragmentManager
                .beginTransaction()
                .replace(R.id.containerView, new SwipeTabsFragment())
                .commit();

        /*mFragmentTransaction = mFragmentManager.beginTransaction();
        mFragmentTransaction.replace(R.id.containerView, new SwipeTabsFragment()).commit();*/
    }
